...
<div className='container'>
    ...
    <img src="https://i.pinimg.com/564x/51/e9/2c/51e92c074426a5b582bdbacc90fa0bc7.jpg" alt="" className='image'/>
      <Card className="max-w-md mx-auto p-4 rounded-md text-black bg-white">
        ...
        <div className="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Log in to <span className="text-[#7747ff]">Exclusive</span></div>
        ...
        <form className="flex flex-col gap-3">
          <div className="block relative"> 
            ...
            <Input type="email" color="lightBlue" placeholder="Enter your Email" />
          </div>
          <div className="block relative"> 
